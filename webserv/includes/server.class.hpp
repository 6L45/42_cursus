...
*/
#define SV_DIRISACTIVE(location) (location->options & (1 << 0))
#define SV_BODYISLIMITED(location) (location->options & (1 << 1))
#define SV_GETISSET(location) (location->methods & (1 << 0))
#define SV_POSTISSET(location) (location->methods & (1 << 1))
#define SV_DELETEISSET(location) (location->methods & (1 << 2))
#define SV_PUTISSET(location) (location->methods & (1 << 3))
#define SV_HEADISSET(location) (location->methods & (1 << 4))
...
class Server
{
	...
	private :
		...
		std::string					_root;
		std::string					_error_default_root;
		std::string					_name;
		char						**_env;
